...
public class JavaMelodyConfiguration implements ServletContextInitializer {
    ...
    public FilterRegistrationBean javaMelody() {
        ...
        // to add basic auth:
         javaMelody.addInitParameter(Parameter.AUTHORIZED_USERS.getCode(), "mon:monitoring");
        // to change the default storage directory:
         javaMelody.addInitParameter(Parameter.MONITORING_PATH.getCode(), "/public/monitoring");
